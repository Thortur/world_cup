    ...
    <div class="collapse navbar-collapse" id="menuPrincipale">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="/app/page/home.php">Accueil <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/app/page/bet.php">Pari</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/app/page/classement.php">Classement</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/app/page/groupe.php">Groupe</a>
            </li>
